...
class Game {
    ...
    update(deltaTime) {
        ...
        // Update controls and apply engine throttle
        if (this.controls) {
            this.controls.deltaTime = scaledDeltaTime;
        ...
        this.updateCamera(scaledDeltaTime);
        
        // Update UI elements
        this.updateUI();
        
        // Check race conditions if race is active
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6e88586f5c9de08ee78d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.db8eb905cafa9ed54c4b.hot-update.js.map