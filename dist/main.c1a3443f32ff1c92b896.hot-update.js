...
class Environment {
    ...
    createBasicWaterMesh() {
        console.log("Using basic water implementation instead of WebGL water");
        
        // Create a simple plane with more segments for wave animation
        const waterGeometry = new THREE.PlaneGeometry(5000, 5000, 64, 64);
        ...
        for (let i = 0; i < position.count; i++) {
            this.waterVertices.push({
                ...
                z: position.getZ(i),
                originalY: 0,
                randomHeight: Math.random() * 2 - 1,
                randomSpeed: Math.random() * 0.5 + 0.5
            });
        }
        
        // Make sure we have wave components for calculations
        this.initWaveComponents();
    }
     ...
     */
    updateWaterMesh() {
        // If we're using the WebGL water, update it
        ...
        for (let i = 0; i < position.count; i++) {
            ...
            if (Math.abs(x) > 2400 || Math.abs(z) > 2400) {
                position.setY(i, 0);
                continue;
            }
            ...
            if (this.waterVertices && this.waterVertices[i]) {
                const vert = this.waterVertices[i];
                height += Math.sin(now * vert.randomSpeed + vert.x * 0.2) * vert.randomHeight * 0.1;
            }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("39e4ec4cb649fbf09636")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.c1a3443f32ff1c92b896.hot-update.js.map