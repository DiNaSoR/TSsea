...
class Boat {
    ...
    /**
     * Load model with THREE.GLTFLoader
     */
    loadModelWithLoader(modelPath) {
        ...
        return new Promise((resolve, reject) => {
            loader.load(
                ...
                // onError callback
                (error) => {
                    console.error("THREE.GLTFLoader failed with path:", modelPath, error);
                    reject(error);
                }
            );
        });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("08111946b57d2a527a7c")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.45a42ae80509ff2bd24f.hot-update.js.map