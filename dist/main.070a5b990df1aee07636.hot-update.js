...
class Boat {
    ...
    calculateForces(wind, waves) {
        ...
        if (this.rudderAngle !== 0 && this.speed > 0.5) {
            ...
            const speedFactor = Math.min(this.speed / 5, 1.5);
            ...
            // Also apply angular velocity based on rudder angle and speed
            // Turning gets harder at high speeds
            let angularFactor = this.speed < 5 ? 0.015 : 0.01;
            // Stronger turning at low speeds for better handling
            if (this.speed < 2) angularFactor = 0.02;
            
            // Direction is reversed when going backward
            const directionModifier = this.velocity.dot(boatDirection) < 0 ? -1 : 1;
            
            this.angularVelocity.y = this.rudderAngle * this.speed * angularFactor * directionModifier;
        } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9c2047f078835c67f625")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.070a5b990df1aee07636.hot-update.js.map