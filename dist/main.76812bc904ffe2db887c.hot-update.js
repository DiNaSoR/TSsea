...
class Game {
    ...
    startSinglePlayer() {
        ...
        // Create a local boat for the player
        this.localBoat = new _boat_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
            id: 'player',
            playerName: 'Player',
        ...
        // Set camera view to orbit mode by default
        ...
        this.state.timeOfDay = 12; // Noon by default
        this.lastUpdateTime = performance.now() / 1000;
        requestAnimationFrame(this.gameLoop);
        
        // Mark game as started and hide the loading screen
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e5cea7e0ffd20cee51f7")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.76812bc904ffe2db887c.hot-update.js.map