...
class Boat {
    ...
    calculateForces(wind, waves) {
        ...
        if (this.throttle > 0) {
            const forceMagnitude = this.enginePowerCoefficient * this.throttle;
        ...
        if (this.rudderAngle !== 0 && this.speed > 0) {
            ...
            const forceMagnitude = this.rudderForceCoefficient * this.rudderAngle * this.speed;
            rudderForce.copy(rudderDirection).multiplyScalar(forceMagnitude);
            
            // Also apply angular velocity based on rudder angle
            this.angularVelocity.y = this.rudderAngle * this.speed * 0.01;
        } else {
        ...
        if (this.velocity.lengthSq() > 0) {
            ...
            const dragMagnitude = this.dragCoefficient * velocityMagnitude * velocityMagnitude;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8fa6ab2b339de7bc57ff")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.7493c24b2c8ceea2017d.hot-update.js.map