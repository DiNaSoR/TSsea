...
class Boat {
    ...
    calculateForces(wind, waves) {
        ...
        if (this.rudderAngle !== 0) {
            ...
            // Make sure A turns left and D turns right consistently
            // Apply direct rudder angle to angular velocity to ensure continuous turning
            this.angularVelocity.y = this.rudderAngle * Math.max(this.speed, 0.5) * angularFactor * directionModifier;
            
            // Store the last rudder angle to detect changes
            this.lastRudderAngle = this.rudderAngle;
        } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("aba9413b5b15259a6622")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5c14dc2d425d98cc7168.hot-update.js.map