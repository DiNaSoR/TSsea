...
class Boat {
    ...
    calculateForces(wind, waves) {
        ...
        if (this.throttle !== 0) {
            ...
            console.log("Engine force:", this.throttle, forceMagnitude, engineForce.length());
    ...
    updateMesh() {
        ...
        try {
            ...
            this.mesh.position.copy(this.position);
            console.log("Mesh position updated:", this.mesh.position.x, this.mesh.position.y, this.mesh.position.z);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("622206ba6ea4a91d04f1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.69db762cbf69bff3513a.hot-update.js.map