...
class Controls {
    ...
    constructor(options = {}) {
        ...
        this.rudderSensitivity = 7.0; // Significantly increased for even easier steering (was 4.5)
    ...
    update(deltaTime) {
        ...
        // Debug output to see which keys are pressed
        ...
        if (rudderInput !== 0) {
            ...
            if (this.state.rudderAngle !== 0) {
                ...
                // Extremely slow return rate for better turning control
                const returnRate = this.rudderSensitivity * 0.01 * (deltaTime / (1/60));
        ...
        // Notify listeners if controls changed
        if (controlsChanged && this.onControlsChange) {
            console.log("Control state changed:", 
                "rudder:", this.state.rudderAngle, 
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9183083dd41459213636")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.ba68d6bec72a1d064877.hot-update.js.map