...
class Boat {
    ...
    update(environment, deltaTime) {
        ...
        console.log("Forces calculated:", forces.length());
        ...
        console.log("New velocity:", this.velocity.length());
        ...
        try {
            ...
            if (this.mesh) {
                this.mesh.position.copy(this.position);
                console.log("Updated mesh position:", this.position.x, this.position.y, this.position.z);
            } else {
        ...
        console.log("Position change:", movement.length());
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4786c1d770f6619e1887")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.6a8721d6c0c50d3406f6.hot-update.js.map