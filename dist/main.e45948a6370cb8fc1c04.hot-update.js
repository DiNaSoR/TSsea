...
class Game {
    ...
    update(deltaTime) {
        ...
        // Ensure orbit camera always follows the boat
        if (this.renderer.controls && this.localBoat) {
            // Force update the target position to the boat's current position
    ...
    setCameraView(view) {
        ...
        // Disable panning - boat must always be the focus
        this.renderer.controls.enablePan = false;
        
        // Set the boat as the follow target for the camera
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c8e1490683c42351e19a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.e45948a6370cb8fc1c04.hot-update.js.map