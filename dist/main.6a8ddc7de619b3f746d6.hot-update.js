...
class Renderer {
    ...
    start(updateCallback) {
        ...
        const animate = (time) => {
            ...
            // Make sure boat position is tracked by camera - only if not using OrbitControls
            ...
            if (this.controls) {
                // For orbit controls, ensure target is at boat position
                if (this.controls instanceof three_examples_jsm_controls_OrbitControls_js__WEBPACK_IMPORTED_MODULE_1__.OrbitControls && this.followBoat) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7fdcd677e57d732bb7a2")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.6a8ddc7de619b3f746d6.hot-update.js.map