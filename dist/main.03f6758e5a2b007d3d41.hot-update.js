...
class Boat {
    ...
    updateEngineEffects() {
        ...
        const emissionRate = Math.ceil(this.throttle * 2); // More particles at higher throttle
        ...
        for (let i = 0; i < emissionRate; i++) {
            ...
            // Reset velocity - direction depends on boat orientation
            const velocity = new THREE.Vector3(
                (Math.random() - 0.5) * 0.05,
                Math.random() * 0.1 + 0.05,
                -Math.random() * 0.2 - 0.1  // Mostly backward
            );
            velocity.applyQuaternion(this.orientation);
        ...
        this.engineParticles.system.material.opacity = 0.6 * this.throttle;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("af604379e66d42b7eb1a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.03f6758e5a2b007d3d41.hot-update.js.map